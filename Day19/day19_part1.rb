...
def calculate_beacon_configurations(beacons)
...
class Scanner
  ...
  def initialize(beacons)
    @beacon_configurations = calculate_beacon_configurations(beacons)
  end
...
pp scanner_zero.beacon_configurations[0].length
